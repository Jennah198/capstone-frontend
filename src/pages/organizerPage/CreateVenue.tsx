...
const CreateVenue: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        setMessage(responseData.message || "Failed to create venue");
        toastError(responseData.message || "Failed to create venue");
      } else {
  ...
  return (
    <div className="mt-8 w-full flex justify-center items-center p-8 pt-20">
      {/* Message Alert */}
      {message && (
