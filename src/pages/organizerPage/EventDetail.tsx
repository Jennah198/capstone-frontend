...
interface Status {
  type: "draft" | "published" | "upcoming" | "ongoing" | "completed";
  label: string;
  color: string;
}
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await axios.delete(
        `${BASE_URL}/api/events/delete-event/${id}`,
        { withCredentials: true }
      );
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-600">
                Created on {formatDate(event.createdAt)} • Last updated on{" "}
              ...
              {event.image ? (
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src = "https://picsum.photos/800/400";
                  }}
                />
              ) : (
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center gap-2">
                        ...
                        {status.type === "completed" && (
                          <FaTimesCircle className="text-purple-500" />
                        )}
                        {status.type === "draft" && (
            ...
            <div className="bg-white rounded-xl shadow border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  {event.vipPrice?.quantity && event.vipPrice.quantity > 0 ? (
                    <div className="flex items-center justify-between text-sm text-gray-600">
                      <span>Available:</span>
