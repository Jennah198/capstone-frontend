...
const AdminOrderListPage: React.FC = () => {
  ...
  const updateOrderStatus = async (orderId: string, newStatus: 'paid' | 'pending' | 'failed') => {
    try {
      ...
      if (response.data.success) {
        ...
        toastSuccess(response.data?.message || 'Order status updated');
      }
    } catch (error) {
  ...
  const deleteOrder = async (orderId: string) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setAllOrders(updatedAllOrders);
        toastSuccess(response.data?.message || 'Order deleted successfully');
      }
    } catch (error) {
  ...
  const getTicketTypeBadge = (type: string): Badge => {
    const badges: Record<string, Badge> = {
                    ...
                    <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <select
                              ...
                              onChange={(e) => updateOrderStatus(order._id, e.target.value as 'paid' | 'pending' | 'failed')}
                      ...
                      <div className="col-span-1">
                        <div className="flex items-center gap-5 justify-end">
                          <button className="text-blue-700 rounded-lg">
                            <FaEye />
                          </button>
                          <button
