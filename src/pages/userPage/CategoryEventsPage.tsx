...
const CategoryEventsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (categoryId) fetchCategoryEvents();
  }, [categoryId]);
  ...
  const fetchCategoryEvents = async () => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/api/events/get-eventByCategory/${categoryId}`, {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link to="/" className="bg-gray-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-700 transition">
              Back to Home
            </Link>
          </div>
        </div>
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <div className="flex items-center justify-between text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span>From ${isFinite(eventMinPrice) ? eventMinPrice : 'Free'}</span>
                        </div>
                      </div>
                    </div>
